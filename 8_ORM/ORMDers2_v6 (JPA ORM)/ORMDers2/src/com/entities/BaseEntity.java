...
public class BaseEntity implements Serializable {
	...
	@TableGenerator(allocationSize = 1, initialValue = 1, table = "PK_ANA_TABLOSU", name = "PK_ANA_TABLOSU", pkColumnName = "PK_NAME", pkColumnValue = "PK_VAL")
	private Long id;
	...
	private void kayittanOnce() {
		System.out.println("Kayýttan Önce");
	}

	@PostPersist
	private void kayittanSonra() {
		System.out.println("Kayýttan Sonra");
	}
